<?php /*a:3:{s:71:"F:\phpstudy\PHPTutorial\WWW\crm\application\admin\view\index\index.html";i:1539309467;s:71:"F:\phpstudy\PHPTutorial\WWW\crm\application\admin\view\common\head.html";i:1539251508;s:71:"F:\phpstudy\PHPTutorial\WWW\crm\application\admin\view\common\foot.html";i:1539251465;}*/ ?>
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="<?php echo url('admin/index/index'); ?>">
                  <span style="font-size: 22px;"><?php echo config('sys_name'); ?>CRM</span>
                </a>
            ...
            <ul class="layui-nav admin-header-item" lay-filter="side-top-right">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><!--个人信息-->
                            <a href="<?php echo url('index/info'); ?>"><i class="fa fa-sign-out" aria-hidden="true"></i><?php echo lang('person_info'); ?></a>
                        </dd>
                        <dd><!--修改密码-->
                            <a href="<?php echo url('index/updatePassword'); ?>"><i class="fa fa-sign-out" aria-hidden="true"></i><?php echo lang('update_password'); ?></a>
                        </dd>
                    </dl>
                </li>
            </ul>
    ...
    <div class="layui-footer footer footer-demo" id="admin-footer">
        <div class="layui-main">
            <p>2017 &copy;
                <a href="http://www.cdwyzx.com/">www.cdwyzx.com</a> Apache Licence 2.0
            </p>
        </div>
    </div>
