<?php /*a:1:{s:71:"F:\phpstudy\PHPTutorial\WWW\crm\application\admin\view\login\index.html";i:1539251516;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
    <meta charset="utf-8">
                ...
                <div class="beg-login-box">
                    ...
                    <div class="beg-login-main">
                        <form class="layui-form layui-form-pane" method="post">
                            ...
                            <div style="color: #f00;"><?php echo config('self_moto'); ?></div>
                        </form>
                    </div>
                    <footer>
...
<script>
    layui.use('form',function(){
        ...
        form.on('submit(login)', function(data){
            ...
            $.post('<?php echo url("login/index"); ?>',data.field,function(res){  //res  => login/index的返回值
                console.log(res); //返回主键 username avatar
                layer.close(loading);
                if(res.code == 1){
