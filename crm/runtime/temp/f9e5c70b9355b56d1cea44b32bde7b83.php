<?php /*a:3:{s:74:"F:\phpstudy\PHPTutorial\WWW\crm\application\admin\view\template\index.html";i:1539251536;s:71:"F:\phpstudy\PHPTutorial\WWW\crm\application\admin\view\common\head.html";i:1539251508;s:71:"F:\phpstudy\PHPTutorial\WWW\crm\application\admin\view\common\foot.html";i:1539251465;}*/ ?>
    ...
    <div>
        ...
        <div class="table-responsive">
            <table class="layui-table table-hover">
                ...
                <tr>
                    <td><?php echo htmlentities($v['filename']); ?></td>
                    <td><?php echo htmlentities($v['filesize']); ?></td>
                    <td><?php echo toDate($v['filemtime'],'Y-m-d h:i:s'); ?></td>
                    <td>
                        <a href="<?php echo url('edit',['file'=>$v['filename'],'type'=>input('param.type')]); ?>" class="layui-btn layui-btn-xs"><?php echo lang('edit'); ?></a>
                        <a href="javascript:;" onclick="return del('<?php echo htmlentities($v['filename']); ?>')" class="layui-btn layui-btn-xs layui-btn-danger"><?php echo lang('del'); ?></a>
                    </td>
                </tr>
